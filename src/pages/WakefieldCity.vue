    ...
    <div class="container">
      <div class="row pt-4 d-flex flex-column-reverse flex-lg-row">
        ...
        <div class="col-lg-6 col-sm-12 d-flex align-self-center flex-column mt-3 mt-md-0 pb-4">
          <h1 class="text-white text-start"><span class="my-yellow">Locksmith</span> in Wakefield</h1>
...
export default {
  ...
  metaInfo: {
    title: 'Locksmith in Wakefield',
    meta: [
      {
        vmid: 'description',
        name: 'description',
        content: '24/7 emergency locksmith services in Wakefield. Locksmith4All also provide a range of services and supplies designed to improve the security of your home or business'
      }
    ]
  }
